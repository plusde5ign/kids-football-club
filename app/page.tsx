...
function Brand() {
  return <a href="#acasa" className="brand" aria-label="Golden Kids Brașov, începutul paginii"><img className="brand-logo" src="/apple-touch-icon.png" alt="" /><span className="brand-name">Golden Kids<span>Brașov</span></span></a>;
}
...
export default function Home() {
  ...
  const gallery = [
    ...
    { image: "/images/goalkeeper-golden-kids.webp", title: "Curaj la fiecare minge.", alt: "Copil portar în bluză verde, șort negru cu protecții și mănuși, pregătit să apere poarta", className: "gallery-team" },
  ];
    ...
    <header className="site-header">
      ...
      <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
        ...
        <SheetContent className="mobile-menu" showCloseButton={false}>
          <SheetTitle className="mobile-title">Golden Kids<br />Brașov</SheetTitle><SheetDescription className="sr-only">Navigarea paginii</SheetDescription>
